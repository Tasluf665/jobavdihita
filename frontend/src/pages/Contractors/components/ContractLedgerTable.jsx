...
function ContractLedgerTable({ rows = [], pagination, onPageChange }) {
    return (
        <section className="contractors-ledger-wrap" aria-label="Contract ledger">
            <header className="contractors-ledger-head">
                <h3>Full Contract Ledger</h3>
            </header>
...
export default ContractLedgerTable;
